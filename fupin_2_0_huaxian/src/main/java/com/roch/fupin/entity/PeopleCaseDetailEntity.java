...
public class PeopleCaseDetailEntity extends BaseEntity{
	...
	private int poorreson_m_fc;//自身发展动力不足户数
	private int poorreson_m_pc;//自身发展动力不足人数
	...
	public int getPoorreson_m_fc() {
		return poorreson_m_fc;
	}

	public void setPoorreson_m_fc(int poorreson_m_fc) {
		this.poorreson_m_fc = poorreson_m_fc;
	}

	public int getPoorreson_m_pc() {
		return poorreson_m_pc;
	}

	public void setPoorreson_m_pc(int poorreson_m_pc) {
		this.poorreson_m_pc = poorreson_m_pc;
	}
