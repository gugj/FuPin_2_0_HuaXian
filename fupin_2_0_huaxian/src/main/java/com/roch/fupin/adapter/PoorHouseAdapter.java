...
//			if (poorHouse.getIfpeixun()!=null && poorHouse.getIfpeixun().equals("是")) {
//				holderView.cb_train.setChecked(true);
//			}else if(poorHouse.getIfpeixun()!=null && poorHouse.getIfpeixun().equals("否")) {
