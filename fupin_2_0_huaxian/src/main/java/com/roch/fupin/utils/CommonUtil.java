...
public class CommonUtil {
	...
	public void getState() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) { // KITKAT
			...
			tintManager.setStatusBarTintDrawable(ResourceUtil.getInstance().getDrawableByID(R.color.title_color));// 通知栏颜色 R.color.bule_155bbb
		}
	}
